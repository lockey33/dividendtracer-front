...
export const useSearchHistory = () => {
    ...
    const getSearchHistoryBDD = async() => {
        let data = await axios({
            method: 'post',
            url: 'https://159.223.127.45:3001/v1/users/getUserSearchHistory',
            data: {
                address: account
            }
        })
    ...
    const addToSearchHistoryBDD = async(tokenAddress, tokenName, symbol) => {
        ...
        let data = axios({
            method: 'post',
            url: 'https://159.223.127.45:3001/v1/users/addToSearchHistory',
            data: {
                address: account,
    ...
    const removeFromSearchHistoryBDD = async(tokenAddress) => {
        ...
        let data = axios({
            method: 'post',
            url: 'https://159.223.127.45:3001/v1/users/removeFromSearchHistory',
            data: {
                address: account,
                tokenAddress: tokenAddress
            }
