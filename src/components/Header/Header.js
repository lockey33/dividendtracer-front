        ...
        <HeaderWrapper justifyContent="space-between" alignItems="center">
            <LogoWrapper onClick={() => history.push('/')}>
                ...
                <Box>
                    ...
                    <p>by <a href="https://ponyswap.org">ponyswap.org</a></p>
                </Box>
            </LogoWrapper>
            <ActionsWrapper>
                <Flex sx={{'@media screen and (max-width: 997px)': {display: 'none'}}} alignItems="center" color="white">
                    <TelegramButton id="telegramHeader" rel="noreferrer" target="_blank" href="https://ponyswap.org">Launch Ponyswap <FaRocket color="white" /></TelegramButton>
                </Flex>
                <WalletWrapper />
                    ...
                    <OptionsButton onClick={() => setIsOptionsOpen(!isOptionsOpen)} id="openMenuTop">
                        ...
                        {isOptionsOpen &&
                            <OptionsMenuWrapper ref={wrapperRef}>
                                <OptionsMenu>
                                    <Link display={'flex'} alignItems='center' justifyContent="space-between" color="#a0a0a1" fontSize={[2]} sx={{gap: '10px', textDecoration: "none", "svg":{opacity: 0.6}}} id="telegramMenu" rel="noreferrer" target="_blank" href="https://t.me/ponyswapEN">Launch Ponyswap <MdLaunch /></Link>
                                    <Link display={'flex'} mt={2} alignItems='center' justifyContent="space-between" color="#a0a0a1" fontSize={[2]} sx={{gap: '10px', textDecoration: "none", "svg":{opacity: 0.6}}} id="telegramMenu" rel="noreferrer" target="_blank" href="https://t.me/ponyswapEN">Join our telegram <FaTelegramPlane /></Link>
